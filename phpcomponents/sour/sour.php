...
<head>
    ...
    <link rel="stylesheet" href="./sourR.css">
...
<body>
    ...
    <main class="table">
        ...
        // JOIN location ON addorphan.locationID = location.locationid";
                    ...
                    //     <a href=deletesour.php?id=".$row["idorphan"]." class='link-dark'><i class='fa-solid fa-trash fs-5'></i></a>
                    //   </td>";
                    //   echo "<tr>";
                    }
